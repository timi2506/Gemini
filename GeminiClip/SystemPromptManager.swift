...
class SystemPromptManager: ObservableObject {
    ...
    init() {
        let existing = UserDefaults(suiteName: "group.timi2506.Gemini")!.string(forKey: "customSystemPrompt")
    ...
    @Published var customSystemPrompt: String? {
        didSet {
            if let customSystemPrompt {
                UserDefaults(suiteName: "group.timi2506.Gemini")!.set(customSystemPrompt, forKey: "customSystemPrompt")
            } else {
                UserDefaults(suiteName: "group.timi2506.Gemini")!.removeObject(forKey: "customSystemPrompt")
            }
        }
    }
