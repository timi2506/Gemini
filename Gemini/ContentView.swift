...
struct ContentView: View {
    @AppStorage("Formal", store: UserDefaults(suiteName: "group.timi2506.Gemini")) var formal = false
    @State var message = ""
    ...
    @AppStorage("aiModel", store: UserDefaults(suiteName: "group.timi2506.Gemini")) var selectedModelData: Data = Data()
        ...
        NavigationStack {
            Form {
                VStack(alignment: .leading) {
                    ...
                    Text("Requires a Restart of the App to Function")
                        .font(.caption)
